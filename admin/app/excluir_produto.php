...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // Obtenha o ID do produto a ser excluído do POST
    $produtoId = $_POST["id"];
    ...
    if (!$resultado) {
        ...
        die("Erro na exclusão do produto: " . $conn->error);
    }

    // Feche a conexão com o banco de dados
    $conn->close();
} else {
    // Redirecione para a página de lista de produtos se a solicitação não for POST
