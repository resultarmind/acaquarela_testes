  ...
  <body>
    ...
    <div class="br-mainpanel">
      <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <span class="breadcrumb-item active">Alterar Slides</span>
        </nav>
      </div><!-- br-pageheader -->
      <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
        <h4 class="tx-gray-800 mg-b-5">Alterar Slide</h4>
        <p class="mg-b-0">Realize alterações em um slide através do formulário abaixo.</p>
      </div>

      <div class="br-pagebody">
        <div class="br-section-wrapper">

        <form action="salvar_slide_edit.php" method="post" enctype="multipart/form-data">
    ...
    <div class="card bd-0 mb-3" style="max-width: 250px;">
        <div class="card-body bd color-gray-lighter rounded">
            <h6 class="mg-b-3"><a href="" class="tx-dark">Imagem atual do Slide</a></h6>
