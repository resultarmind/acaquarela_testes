    ...
    <div class="br-mainpanel">
      <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <span class="breadcrumb-item active">Visualizar Produtos Recomendados</span>
        </nav>
      </div><!-- br-pageheader -->
      <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
        <h4 class="tx-gray-800 mg-b-5">Visualizar Produtos Recomendados</h4>
        <p class="mg-b-0">Visualize, edite ou exclua um produto recomendado.</p>
      </div>
      ...
      <div class="br-pagebody">
        ...
        <a href="add_rc.php" class="btn btn-primary mb-4">Adicionar Produto</a>
...
$query = "SELECT * FROM produtos_recomendados";
...
?>
    ...
    <img class="img__full" src="../../images/BD/<?php echo $linha["imagem"]; ?>" alt="<?php echo $linha["nome"]; ?>" style="max-width: 150px; max-height: 150px;">
</td>
<td class="text-center">
<a href="editar_produto_rc.php?id=<?php echo $linha["id"]; ?>" class="btn btn-primary btn-sm" title="Editar">
...
$(document).ready(function() {
    ...
    $(".excluir-imagem2").click(function() {
        ...
        Swal.fire({
            title: 'Tem certeza?',
            text: "Tem certeza de que deseja excluir este produto recomendado?",
            icon: 'warning',
