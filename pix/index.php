...
<head>
   ...
   <meta name="description"
      content="Gerador gratuito de QR Code e BR Code do Pix. Gere o seu QR Code ou a linha digitável do Pix Copia e Cola.">
...
//   $px[62][50][01]="1.2.006"; //Payment system specific template - versão
   ...
   ?>
      <div class="card">
         <h3 class="text-center">Linha do Pix (copia e cola):</h3>
         <div class="row p-3">
            <div class="col text-center">
               <p class="text-monospace" id="brcodepix" rows="<?= $linhas; ?>" cols="130"><?= $pix;?></p>
            </div>
            <div class="col md-1">
               <p>
                  <button type="button" id="clip_btn" class="btn btn-primary" data-toggle="tooltip" data-placement="top"
                     title="Copiar código pix" onclick="copiar()">
      ...
      <script>
         function copiar() {
            ...
            // Set the text content to the paragraph's text
      ...
      <h3 class="text-center mt-3">Imagem de QRCode do Pix:</h3>
      <p>
...
?>
         ...
         <h3 class="text-center">Gerador de QR Code do PIX</h3>
            ...
            <div class="card-body">
               <form method="post" action="index.php">
                  ...
                  <div class="row row-cols-lg-auto align-items-center">
                     ...
                     <input type="text" class="form-control" id="chave" name="chave" placeholder="Informe a chave pix"
                     ...
                     <div id="chaveHelp" class="form-text">A chave pode ser: Aleatória (EVP), E-mail, Telefone, CPF ou
                        CNPJ.</div>
                  </div>
                  ...
                  <div class="row row-cols-lg-auto align-items-center mt-3">
                     ...
                     <div id="valorHelp" class="form-text">Utilize o ponto "." como separador de decimais. Prencher 0
                        caso não deseje especificar um valor.</div>
                  </div>
                  <div class="row row-cols-lg-auto align-items-center mt-3">
                     <label for="beneficiario" class="form-label">Nome do beneficiário:</label>
                     <input type="text" id="beneficiario" class="form-control" name="beneficiario"
                  ...
                  <div class="row row-cols-lg-auto align-items-center mt-3">
                     ...
                     <div id="identificadorHelp" class="form-text">Utilizar <b>***</b> para identificador gerado
                        automaticamente.O Banco Itaú exige a autorização para uso de identificador que não tenha sido
                        criado pelo aplicativo do próprio banco, <a
                           href="https://github.com/bacen/pix-api/issues/214">saiba mais</a>.</div>
                  </div>

                  <p><button type="submit" class="btn btn-primary">Gerar QR Code <i class="fas fa-qrcode"></i></button>&nbsp;<a href="?gerarpix" class="btn btn-info">Ajude a manter este projeto <i class="fas fa-hand-holding-usd"></i></a>&nbsp;</p>
